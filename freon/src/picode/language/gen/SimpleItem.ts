...
import { INamedConcept, Type, SimpleformsMetaType } from "./internal";

/**
 * Class SimpleItem is the implementation of the concept with the same name in the language definition file.
 * It uses mobx decorators to enable parts of the language environment, e.g. the editor, to react
 * to changes in the state of its properties.
 */
export class SimpleItem extends MobxModelElementImpl implements FreNamedNode, INamedConcept {
    /**
     * A convenience method that creates an instance of this class
     * based on the properties defined in 'data'.
     * @param data
     */
    static create(data: Partial<SimpleItem>): SimpleItem {
        const result = new SimpleItem();
        if (!!data.name) {
    ...
    readonly $typename: SimpleformsMetaType = "SimpleItem"; // holds the metatype in the form of a string
    ...
    type: Type; // implementation of part 'type'
     ...
     * @param toBeMatched
     */
    public match(toBeMatched: Partial<SimpleItem>): boolean {
