...
const LOGGER = new FreLogger("SimpleformsScoper");

/**
 * Class SimpleformsScoper implements the scoper generated from, if present, the scoper definition,
 * otherwise this class implements the default scoper.
 */
export class SimpleformsScoper extends FreScoperBase {
    /**
