...
/**
 * Class PropertiesStdlib provides an entry point for all predefined elements in language properties.
 ...
 */
export class PropertiesStdlib implements FreStdlib {
    ...
    public static getInstance(): FreStdlib {
        if (this.stdlib === undefined || this.stdlib === null) {
            this.stdlib = new PropertiesStdlib();
        }
        return this.stdlib;
    }

    public elements: FreNamedNode[] = []; // the predefined elements of language properties
     ...
     * @param metatype
     */
    public find(name: string, metatype?: PropertiesMetaType): FreNamedNode {
        if (!!name) {
