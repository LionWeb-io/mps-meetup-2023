...
import { PropertiesEveryConcept, PropertiesFile, Property, Value, BooleanValue, DecValue, IntValue, StringValue } from "../../language/gen";
...
/**
 * Class PropertiesModelUnitWriter provides methods to return a string representation of an instance of
 * elements of language properties.
 * It is, amongst others, used to create error messages in the validator.
 */
export class PropertiesModelUnitWriter implements FreWriter {
     ...
     * @param short
     */
    public writeToString(modelelement: PropertiesEveryConcept, startIndent?: number, short?: boolean): string {
     ...
     * @param short
     */
    public writeToLines(modelelement: PropertiesEveryConcept, startIndent?: number, short?: boolean): string[] {
     ...
     * @param modelelement
     */
    public writeNameOnly(modelelement: PropertiesEveryConcept): string {
        if (!modelelement) {
            return "";
        }
    ...
    private unparse(modelelement: PropertiesEveryConcept, short: boolean) {
        if (!modelelement) {
            return;
        }
        switch (modelelement.freLanguageConcept()) {
            case "Property":
                this.unparseProperty(modelelement as Property, short);
                break;
            case "Value":
                this.unparseValue(modelelement as Value, short);
                break;
            case "BooleanValue":
                this.unparseBooleanValue(modelelement as BooleanValue, short);
                break;
            case "DecValue":
                this.unparseDecValue(modelelement as DecValue, short);
                break;
            case "IntValue":
                this.unparseIntValue(modelelement as IntValue, short);
                break;
            case "StringValue":
                this.unparseStringValue(modelelement as StringValue, short);
                break;
            case "PropertiesFile":
                this.unparsePropertiesFile(modelelement as PropertiesFile, short);
                break;
        }
    }
     ...
     */
    private unparseProperty(modelelement: Property, short: boolean) {
    ...
    /**
     * Unparsing of 'Value' according to projection 'default'.
     */
    private unparseValue(modelelement: Value, short: boolean) {
        const blockIndent = this.output[this.currentLine].length;
        // do the first line
        this.output[this.currentLine] += `Value `;
        this.output[this.currentLine] += `\{ `;
    ...
    /**
     * Unparsing of 'BooleanValue' according to projection 'default'.
     */
    private unparseBooleanValue(modelelement: BooleanValue, short: boolean) {
        const blockIndent = this.output[this.currentLine].length;
        // do the first line
        this.output[this.currentLine] += `BooleanValue `;
        this.output[this.currentLine] += `\{ `;
    ...
    /**
     * Unparsing of 'DecValue' according to projection 'default'.
     */
    private unparseDecValue(modelelement: DecValue, short: boolean) {
        const blockIndent = this.output[this.currentLine].length;
        // do the first line
        this.output[this.currentLine] += `DecValue `;
        this.output[this.currentLine] += `\{ `;
    ...
    /**
     * Unparsing of 'IntValue' according to projection 'default'.
     */
    private unparseIntValue(modelelement: IntValue, short: boolean) {
        const blockIndent = this.output[this.currentLine].length;
        // do the first line
        this.output[this.currentLine] += `IntValue `;
        this.output[this.currentLine] += `\{ `;
    ...
    /**
     * Unparsing of 'StringValue' according to projection 'default'.
     */
    private unparseStringValue(modelelement: StringValue, short: boolean) {
        const blockIndent = this.output[this.currentLine].length;
        // do the first line
        this.output[this.currentLine] += `StringValue `;
        this.output[this.currentLine] += `\{ `;
    ...
    /**
     * Unparsing of 'PropertiesFile' according to projection 'default'.
     */
    private unparsePropertiesFile(modelelement: PropertiesFile, short: boolean) {
        const blockIndent = this.output[this.currentLine].length;
        // do the first line
        this.output[this.currentLine] += `PropertiesFile `;
        this.output[this.currentLine] += `${modelelement.name} `;
        this.output[this.currentLine] += `\{ `;
        ...
        if (!short) {
            // do the rest of the lines as well
            this.newlineAndIndentation(blockIndent + 4);
            this.output[this.currentLine] += `props `;
    ...
    private _unparseList(
        list: PropertiesEveryConcept[],
        sepText: string,
        sepType: SeparatorType,
        vertical: boolean,
        indent: number,
        short: boolean,
        method: (modelelement: PropertiesEveryConcept, short: boolean) => void
    ) {
