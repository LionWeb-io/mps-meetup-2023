...
import { INamed, PropertiesFile, Property, Value, BooleanValue, DecValue, IntValue, StringValue } from "../../language/gen";
...
export class PropertiesModelUnitWriter implements FreWriter {
    ...
    private unparse(modelelement: FreNode, short: boolean) {
        ...
        switch (modelelement.freLanguageConcept()) {
            ...
            case "PropertiesFile":
                ...
                break;
            case "INamed":
                this.unparseINamed(modelelement as INamed, short);
                break;
        }
    }
    ...
    /**
     * The abstract concept 'Value' is not unparsed.
     */
    private unparseValue(modelelement: Value, short: boolean) {
        throw new Error("Method unparseValue should be implemented by its (concrete) subclasses.");
    }
    /**
     * The interface 'INamed' is not unparsed.
     */
    private unparseINamed(modelelement: FreNode, short: boolean) {
