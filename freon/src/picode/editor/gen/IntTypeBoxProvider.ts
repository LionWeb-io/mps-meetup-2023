...
import { IntType } from "../../language/gen";

/**
 * This class implements the box provider for a single node of type IntType.
 ...
 */
export class IntTypeBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "IntType";
    }
    ...
    private getDefault(): Box {
        return BoxUtil.labelBox(this._element as IntType, "integer", "top-1-line-0-item-0");
    }
}
