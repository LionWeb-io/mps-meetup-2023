...
import { SimpleItem } from "../../language/gen";

/**
 * This class implements the box provider for a single node of type SimpleItem.
 ...
 */
export class SimpleItemBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "SimpleItem";
    }
    ...
    private getDefault(): Box {
        return BoxFactory.horizontalLayout(
            this._element as SimpleItem,
            "SimpleItem-hlist-line-0",
            "",
            [
                BoxUtil.labelBox(this._element as SimpleItem, "Item", "top-1-line-0-item-0"),
                BoxUtil.textBox(this._element as SimpleItem, "name"),
                BoxUtil.labelBox(this._element as SimpleItem, ":", "top-1-line-0-item-2"),
                BoxUtil.getBoxOrAction(this._element as SimpleItem, "type", "Type", this.mainHandler)
            ],
            { selectable: false }
        );
    }
