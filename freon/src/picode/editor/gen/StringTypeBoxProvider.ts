...
import { StringType } from "../../language/gen";

/**
 * This class implements the box provider for a single node of type StringType.
 ...
 */
export class StringTypeBoxProvider extends FreBoxProvider {
    constructor(mainHandler: FreProjectionHandler) {
        super(mainHandler);
        this.knownBoxProjections = ["default"];
        this.knownTableProjections = ["default"];
        this.conceptName = "StringType";
    }
    ...
    private getDefault(): Box {
        return BoxUtil.labelBox(this._element as StringType, "string", "top-1-line-0-item-0");
    }
}
