...
import { DecValue } from "../../language/gen";

/**
 * This class implements the box provider for a single node of type DecValue.
...
export class DecValueBoxProvider extends FreBoxProvider {
    ...
    private getProperty_file_like(): Box {
        return BoxUtil.textBox(this._element as DecValue, "value");
    }

    private getDefault(): Box {
        return BoxFactory.verticalLayout(this._element as DecValue, "DecValue-overall", "", [
            BoxFactory.horizontalLayout(
                this._element as DecValue,
                "DecValue-hlist-line-0",
                "",
                [
                    BoxUtil.labelBox(this._element as DecValue, "DecValue", "top-1-line-0-item-0"),
                    BoxUtil.labelBox(this._element as DecValue, "{", "top-1-line-0-item-1")
                ],
                { selectable: false }
            ),
            BoxUtil.indentBox(
                ...
                BoxFactory.horizontalLayout(
                    this._element as DecValue,
                    "DecValue-hlist-line-1",
                    "",
                    [
                        BoxUtil.labelBox(this._element as DecValue, "value", "top-1-line-1-item-0"),
                        BoxUtil.textBox(this._element as DecValue, "value")
                    ],
                    { selectable: false }
                )
            ),
            BoxUtil.labelBox(this._element as DecValue, "}", "top-1-line-2-item-0")
        ]);
    }
}
