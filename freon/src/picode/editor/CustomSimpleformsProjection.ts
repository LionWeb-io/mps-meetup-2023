...
/**
 * Class CustomSimpleformsProjection provides an entry point for the language engineer to
 ...
 */
export class CustomSimpleformsProjection implements FreProjection {
    name: string = "Manual";
