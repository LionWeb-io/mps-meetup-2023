...
/**
 * Class CustomSimpleformsActions provides an entry point for the language engineer to
 ...
 */
export class CustomSimpleformsActions implements FreCombinedActions {
